...
public class IntegracaoTest {
	...
	public void emprestimoJurosSimplesTest(boolean segurado, boolean jurosCompostos, double valor, double taxa, int nroParcelas, double valorTotal, double valorParcela) throws Exception {

		EmprestimoDTO esperado = new EmprestimoDTO(segurado, jurosCompostos, valor, taxa, nroParcelas, valorTotal, valorParcela);

		MvcResult result = this.mockMvc.perform(get("/emprestimo/jurosSimples?valor=" + valor + "&parcelas="+ nroParcelas +"&taxa=" + taxa))
			.andDo(print())
	...
	public void emprestimoJurosCompostoTest(boolean segurado, boolean jurosCompostos, double valor, double taxa, int nroParcelas, double valorTotal, double valorParcela) throws Exception {

		EmprestimoDTO esperado = new EmprestimoDTO(segurado, jurosCompostos, valor, taxa, nroParcelas, valorTotal, valorParcela);

		MvcResult result = this.mockMvc.perform(get("/emprestimo/jurosCompostos?valor=" + valor + "&parcelas="+ nroParcelas +"&taxa=" + taxa))
			.andDo(print())
			.andExpect(status().isOk())
			.andReturn();
